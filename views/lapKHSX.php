...
<div id="order-modal" class="modal-overlay">
    <div class="modal-content">
        ...
        <form action="index.php?page=luu-ke-hoach" method="POST">
            ...
            <div class="form-group"><label>Đơn vị:</label> <b id="modal-donVi"></b></div> <div class="form-group"><label>Ngày Giao:</label> <b id="modal-ngayGiao" style="color: red;"></b></div>
            
            <div class="form-group">
                <label>Sản lượng TB/ngày (tham khảo):</label>
                <b id="modal-sanLuongTB"></b> <span>sản phẩm</span> </div>
            ...
            <div class="xuong-block">
                <div class="xuong-header"><h4>Phân công XƯỞNG CẮT</h4></div>
            ...
            <div class="xuong-block">
                <div class="xuong-header"><h4>Phân công XƯỞNG MAY</h4></div>
                <div class="xuong-body">
                    <div class="form-group">
                        <label>Giao Sản phẩm:</label>
