...
<div class="main-layout-wrapper">
    ...
    <main class="main-content">
        ...
        <form id="form-tao-yeu-cau" method="POST" action="index.php?page=luu-yeu-cau-nvl">
            ...
            <div class="form-section" style="margin-bottom: 20px; padding: 20px; border: 1px solid #dee2e6; border-radius: 5px; background-color: #f8f9fa;">
                <div class="form-input-group" style="display: flex; align-items: center; margin-bottom: 15px;">
                    <label for="ten-phieu" style="width: 100px; text-align: right; margin-right: 10px; font-weight: bold;">Tên phiếu</label>
                ...
                <div class="form-input-group" style="display: flex; align-items: center; margin-bottom: 15px;">
                    <label for="nguoi-lap" style="width: 100px; text-align: right; margin-right: 10px; font-weight: bold;">Người lập</label>
                    <input type="text" id="nguoi-lap" name="nguoiLap"
                           value="<?php echo isset($thongTinPhieu['tenNguoiLap']) ? htmlspecialchars($thongTinPhieu['tenNguoiLap']) : 'N/A'; ?>" readonly
                ...
                <div class="form-input-group" style="display: flex; align-items: center;">
                    <label for="ngay-lap" style="width: 100px; text-align: right; margin-right: 10px; font-weight: bold;">Ngày lập</label>
                    <input type="text" id="ngay-lap" name="ngayLap"
            ...
            <div class="materials-section">
                ...
                <table class="data-table list-table" style="width:100%; border-collapse: collapse; border: 1px solid #dee2e6;">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td style="border: 1px solid #dee2e6; padding: 10px; text-align: center;"><?php echo $stt++; ?></td>
                            <td style="border: 1px solid #dee2e6; padding: 10px; text-align: left;">
                                <input type="hidden" name="maNVL[]" value="<?php echo isset($nvl['maNVL']) ? $nvl['maNVL'] : ''; ?>">
                                <input type="text" name="tenNVL[]" value="<?php echo isset($nvl['tenNVL']) ? htmlspecialchars($nvl['tenNVL']) : ''; ?>" readonly style="border:none; background:transparent; width: 100%;">
                            </td>
                            <td style="border: 1px solid #dee2e6; padding: 10px; text-align: left;">
                            ...
                            <td style="border: 1px solid #dee2e6; padding: 10px; text-align: center;">
                                <input type="number" name="soLuong[]" value="<?php echo isset($nvl['soLuongNVL']) ? $nvl['soLuongNVL'] : 0; ?>" readonly style="width: 80px; text-align:center; padding: 5px; border: 1px solid #ced4da; border-radius: 4px; background-color: #e9ecef; color: #6c757d;">
                            </td>
                            <td style="border: 1px solid #dee2e6; padding: 10px; text-align: center;">
                                <?php echo isset($nvl['donViTinh']) ? htmlspecialchars($nvl['donViTinh']) : 'N/A'; ?>
                                <input type="hidden" name="donViTinh[]" value="<?php echo isset($nvl['donViTinh']) ? htmlspecialchars($nvl['donViTinh']) : ''; ?>">
                            </td>
                            <td style="border: 1px solid #dee2e6; padding: 10px;">
                                <input type="text" name="ghiChu[]" placeholder="Ghi chú..." style="width: 100%; padding: 5px; border: 1px solid #ced4da; border-radius: 4px;">
                            </td>
                        </tr>
                        <?php
                            endforeach;
                        ...
                        ?>
                            <tr>
                                <td colspan="6" style="border: 1px solid #dee2e6; padding: 10px; text-align: center; color: #6c757d;">
            ...
            <div class="footer-box-buttons" style="border: 1px solid #dee2e6; background-color: #f8f9fa; padding: 20px; margin-top: 30px; display: flex; justify-content: center; gap: 20px; border-radius: 5px;">
                <button type="submit" class="btn btn-approve" style="border: none; padding: 10px 25px; font-size: 1em; font-weight: bold; color: white; border-radius: 5px; cursor: pointer; background-color: #28A745;">Lập phiếu</button>
                <a href="index.php?page=tao-yeu-cau-nvl" class="btn btn-reject" style="display: inline-block; border: none; padding: 10px 25px; font-size: 1em; font-weight: bold; color: white; border-radius: 5px; cursor: pointer; background-color: #DC3545; text-decoration: none;">Thoát</a>
            </div>
        </form> </main> </div> <div class="modal-overlay" id="confirm-create-modal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0, 0, 0, 0.5); justify-content: center; align-items: center; z-index: 1000;">
    <div class="modal-content" style="background-color: white; padding: 30px 40px; border-radius: 8px; text-align: center; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.2); min-width: 300px;">
        <p style="font-size: 1.1em; font-weight: bold; color: #333; margin-bottom: 25px;">Xác nhận lập phiếu yêu cầu?</p>
        <div class="modal-buttons" style="display: flex; justify-content: center; gap: 20px;">
            <button class="btn btn-confirm" id="btn-create-yes" style="border: none; padding: 10px 25px; font-size: 1em; font-weight: bold; color: white; border-radius: 5px; cursor: pointer; background-color: #007bff;">Xác nhận</button>
            <button class="btn btn-cancel" id="btn-create-no" style="border: none; padding: 10px 25px; font-size: 1em; font-weight: bold; color: white; border-radius: 5px; cursor: pointer; background-color: #DC3545;">Hủy</button>
        </div>
    </div>
</div>

<div class="modal-overlay" id="success-create-modal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0, 0, 0, 0.5); justify-content: center; align-items: center; z-index: 1000;">
    <div class="modal-content" style="background-color: white; padding: 30px 40px; border-radius: 8px; text-align: center; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.2); min-width: 300px;">
        <p style="font-size: 1.1em; font-weight: bold; color: #28a745; margin-bottom: 25px;">LẬP PHIẾU THÀNH CÔNG!</p>
        <div class="modal-buttons">
             <button class="btn btn-close-modal" id="btn-success-create-close" style="background-color: #f0f0f0; color: #333; border: 1px solid #ccc; padding: 8px 20px; border-radius: 5px; cursor: pointer;">Đóng</button>
        </div>
    </div>
</div>
